...
Всего 6 параметров: 
1. path - путь до Api, где будут делаться запросы на авторизацию (authorize), проверку авторизации (checkAccessToken) и получение сервисов (getServices). Примеры Api можете найти в директории api в этом репозитории.
...
4. scrollPositionName - параметр для сохранения позиции скролла
5. accessTokenName - название accessToken'а для приложения
6. refreshTokenName - название refreshToken'а для приложения
